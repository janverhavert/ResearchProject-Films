...
const adminAdd = async () => {
  ...
  document.getElementById('Add').onclick = function () {
    ...
    var formData = JSON.stringify({ titel: naam, director: regisseur, releaseDatum: datum, genres: [{ genreId: genreId, genreNaam: genreNaam }], serie: typeBool, duur: parseInt(duur), discription: discription });
    ...
    fetch('https://localhost:44313/api/Add', requestOptions)
